...
#define JL1XXX_LED_STATIC_OP_MODE	JL1XXX_LED_STATIC_C_MACRO
#define JL1XXX_LED_DYNAMIC_OP_MODE	JL1XXX_LED_DYNAMIC_ETHTOOL
...
#define JL1XXX_WOL_STATIC_OP_MODE	JL1XXX_WOL_STATIC_C_MACRO
#define JL1XXX_WOL_DYNAMIC_OP_MODE	JL1XXX_WOL_DYNAMIC_ETHTOOL
...
#define JL1XXX_INTR_STATIC_OP_MODE	JL1XXX_INTR_STATIC_C_MACRO
...
#define JL2XXX_LED_STATIC_OP_MODE	JL2XXX_LED_STATIC_C_MACRO
...
#define JL2XXX_FLD_STATIC_OP_MODE	JL2XXX_FLD_STATIC_C_MACRO
#define JL2XXX_FLD_DYNAMIC_OP_MODE	JL2XXX_FLD_DYNAMIC_ETHTOOL
...
#define JL2XXX_WOL_STATIC_OP_MODE	JL2XXX_WOL_STATIC_C_MACRO
#define JL2XXX_WOL_DYNAMIC_OP_MODE	JL2XXX_WOL_DYNAMIC_ETHTOOL
...
#define JL2XXX_INTR_STATIC_OP_MODE	JL2XXX_INTR_STATIC_C_MACRO
...
#define JL2XXX_DSFT_STATIC_OP_MODE	JL2XXX_DSFT_STATIC_C_MACRO
#define JL2XXX_DSFT_DYNAMIC_OP_MODE	JL2XXX_DSFT_DYNAMIC_ETHTOOL
...
#define JL2XXX_RGMII_STATIC_OP_MODE	JL2XXX_RGMII_STATIC_C_MACRO
...
#define JL2XXX_CLK_STATIC_OP_MODE	JL2XXX_CLK_STATIC_C_MACRO
...
#define JL2XXX_WOEK_MODE_STATIC_OP_EN	(1 << 0)
#define JL2XXX_WOKE_MODE_DYNAMIC_OP_EN	(1 << 1)

#define JL2XXX_UTP_RGMII_MODE		(1 << 2)
#define JL2XXX_FIBER_RGMII_MODE		(1 << 3)
#define JL2XXX_UTP_FIBER_RGMII_MODE	(1 << 4)
#define JL2XXX_UTP_SGMII_MODE		(1 << 5)
#define JL2XXX_PHY_SGMII_RGMII_MODE	(1 << 6)
#define JL2XXX_MAC_SGMII_RGMII_MODE	(1 << 7)
#define JL2XXX_UTP_FIBER_FORCE_MODE	(1 << 8)
...
#define JL2XXX_WORK_MODE_STATIC_OP_MODE		JL2XXX_WORK_MODE_STATIC_C_MACRO
#define JL2XXX_WORK_MODE_DYNAMIC_OP_MODE	JL2XXX_WORK_MODE_OP_NONE

#define JL2XXX_WORK_MODE_CTRL_EN	(JL2XXX_WOEK_MODE_STATIC_OP_EN | \
