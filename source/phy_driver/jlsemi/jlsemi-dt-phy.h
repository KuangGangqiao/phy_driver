...
#define JL1XXX_LED_STATIC_OP_DIS	(1 << 0)
#define JL1XXX_LED_DYNAMIC_OP_DIS	(1 << 1)
...
#define JL1XXX_LED_CTRL_EN	(JL1XXX_LED_STATIC_OP_DIS | \
				 JL1XXX_LED_DYNAMIC_OP_DIS)
...
#define JL2XXX_LED_STATIC_OP_DIS	(1 << 0)
#define JL2XXX_LED_DYNAMIC_OP_DIS	(1 << 1)
...
#define JL2XXX_LED_CTRL_EN	(JL2XXX_LED_STATIC_OP_DIS | \
				 JL2XXX_LED_DYNAMIC_OP_DIS)
...
#define JL2XXX_FLD_STATIC_OP_DIS	(1 << 0)
#define JL2XXX_FLD_DYNAMIC_OP_DIS	(1 << 1)
#define JL2XXX_FLD_DELAY_EN		(1 << 2)

#define JL2XXX_FLD_CTRL_EN		(JL2XXX_FLD_STATIC_OP_DIS | \
					 JL2XXX_FLD_DYNAMIC_OP_DIS)
