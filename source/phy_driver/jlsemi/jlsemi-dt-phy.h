...
#define JL2XXX_UTP_RGMII_MODE		1
#define JL2XXX_FIBER_RGMII_MODE		2
#define JL2XXX_UTP_FIBER_RGMII_MODE	3
#define JL2XXX_UTP_SGMII_MODE		4
#define JL2XXX_PHY_SGMII_RGMII_MODE	5
#define JL2XXX_MAC_SGMII_RGMII_MODE	6
#define JL2XXX_UTP_FIBER_FORCE_MODE	7
